...
from training_repo.python_examples.file_io import parse_csv_content, load_csv_file, summarise_log_file


# def test_parse_csv_content_simple():
#     """Test parse_csv_content for simple CSV content."""
#     content = "name,age\nAlice,30\nBob,25"
...
# def test_parse_csv_content_missing_fields():
#     """Test parse_csv_content for missing fields in CSV rows."""
#     content = "id,value\n1,foo\n2"
#     rows = parse_csv_content(content)
#     assert rows == [
#         {'id': '1', 'value': 'foo'},
...
#     """Test load_csv_file for reading CSV files."""
...
# def test_summarise_log_file(tmp_path):
#     """Test summarise_log_file for summarising log files."""
#     log_lines = [
